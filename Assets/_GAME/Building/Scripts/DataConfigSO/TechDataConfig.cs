...
[System.Serializable]
public struct S_Tech {
    public E_IDTech id;
    public E_StateTech state;
    public string timeCompletedBuilding;
    public Vector2 pos;

    public S_Tech(E_IDTech id, E_StateTech state, string timeCompletedBuilding, Vector2 pos) {
        this.id = id;
        this.state = state;
